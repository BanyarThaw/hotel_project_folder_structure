                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="float-right">
                            <button class="btn btn-white btn-xs" type="button"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;<a href="/hotel-admin/events/create" style="color: black;">Create Event</a></button>
                        </div>
                    </div>
                    @yield('sub_content')
                </div>
