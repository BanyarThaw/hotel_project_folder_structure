                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.html">photos&nbsp;/&nbsp;edit</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="/hotel-admin/gallery/photos/{{ $galleryPhoto->id }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field("PATCH") }}
                            <input type="file" name="photo" required style="position: relative;">
                            <button type="submit" style="border: 1px solid gray;position: relative;"><i class="fa fa-upload fa-2x" aria-hidden="true"></i></button>
                        </form>
                        <br>
                    </div>
                    @yield('sub_content')
