                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.html">videos&nbsp;/&nbsp;edit</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="/hotel-admin/gallery/videos/{{ $video->id }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field("PATCH") }}
                            <input type="file" name="video" required style="position: relative;">
