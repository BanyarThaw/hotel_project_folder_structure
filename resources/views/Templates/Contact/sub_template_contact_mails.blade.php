                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="#">conact mails</a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-12">
                    <div class="float-right">
                        <button class="btn btn-white btn-xs" type="button"><i class="fa fa-envelope" aria-hidden="true"></i></i>&nbsp;<a href="/hotel-admin/reply" style="color: black;">Reply Mails</a></button>
                    </div>
                </div>
            </div>
            @yield('sub_content')
